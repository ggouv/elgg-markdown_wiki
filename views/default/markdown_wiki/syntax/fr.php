...
<div id="link-text-$rand" style="display: none;">
	...
	Vous pouvez <span class="hi">***</span>aussi écrire en gras et italique<span class="hi">***</span> et trouver <span class="hi">___</span>des gras en Italie<span class="hi">___</span>.
	<span class="hi">~~</span>Ce texte est barré<span class="hi">~~</span>.</pre>

	<h4 id="link-echap-char">Echapper les caractères spéciaux</h4>
	<p>Vous pouvez échapper les caractères spéciaux <code>* _ # @ ! `</code> avec <code>\</code> :</p>
	<pre>Ceci n'est pas en <span class="hi">\</span>*gras<span class="hi">\</span>*.</pre>
...
<div id="link-headers-$rand" style="display: none;">
	...
	<p>Vour pouvez aussi utiliser le dièse pour créer jusqu'à 6 niveaux de titre :</p>
	<pre><span class="hi">#</span><span class="spaces">&nbsp;</span>Titre 1 <span class="hi">#</span>
		<span class="hi">##</span><span class="spaces">&nbsp;</span>Titre 2 <span class="hi">##</span>
		<span class="hi">###</span><span class="spaces">&nbsp;</span>Titre 3 <span class="hi">###</span>
		<span class="hi">####</span><span class="spaces">&nbsp;</span>Titre 4 <span class="hi">####</span>
		<span class="hi">#####</span><span class="spaces">&nbsp;</span>Titre 5 <span class="hi">####</span>
		<span class="hi">######</span><span class="spaces">&nbsp;</span>Titre 6 <span class="hi">####</span>
	</pre>
...
<div id="link-code-$rand" style="display: none;">
	...
	<p>Les langages pris en compte sont : markdown, html, css, php, javascript. Pour le reste, si vous ne savez pas, tapez n'importe quoi car ne rien mettre ne formatera pas le code.</p>
